...
import com.example.lttha.a14110180_lethithao_calendarwidget.style.CircleSpan;
import com.example.lttha.a14110180_lethithao_calendarwidget.style.UnderDotSpan;
...
public class MonthView extends RecyclerView {
    ...
    //Set ngày được chọn nếu trong tháng này thì bỏ chọn tất cả các ngày trong tháng
        ...
        public void onBindViewHolder(CellViewHolder holder, int position) {
            if (holder instanceof HeaderViewHolder) {
                ...
                if (position < mStartOffset) {
                    ...
                    if (mSelectedPosition == adapterPosition) {// Nếu là ngày được chọn thì sẽ khoanh tròn
                        spannable.setSpan(new CircleSpan(textView.getContext()), 0,
                                dayString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    } else if (mEvents.contains(dayIndex)) {// nếu là ngày có sự kiện thì có dấu chấm
