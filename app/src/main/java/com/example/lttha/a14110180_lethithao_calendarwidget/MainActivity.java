...
public class MainActivity extends AppCompatActivity
    ...
    public static AdapterEvent pAdapter;
...
//        widget.setOnDateChangeListener(this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent iAddEvent = new Intent(MainActivity.this, AddEvent.class);
                MainActivity.this.startActivity(iAddEvent);
            }
        });

        lv = (ListView) findViewById(R.id.listEvent);
//        dbServer.getListEvent(eventID);
